...
_redux-thunk driven data fetching only as needed_
...
_package-like codebase, single deployment_
...
_uses SkiReg.com as data-source_
...
_brand colors in one place via CSS custom properties (variables)_
